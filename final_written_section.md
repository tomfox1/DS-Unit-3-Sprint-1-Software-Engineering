...
(1)
Code reviews are important in oredr to evaluate other people's code. Albeit subjective at times, 
'best practice' code is advisable to follow, such as code that meets conventional guidelines,
such as PEP8, as well as - when needed - OOP guidelines. I appreciate others giving me specific feedback on my code, 
feedback sometimes can be a little bit to generalized and not too pragmatic. Also, constructive criticism, 
goes a long way. 

(2)
Containers allow us allow us to create a virtual enviorment with a standard operating system, allowing us to 
code in a way which is OS agnostic, therefore making it easier to scale DevOp tasks such as launching thousands of 
servers simulatenously in a efficient, organzied and anti-error prone way. Also, containers allow us to freely
explore others code, code that could sometimes be risky to run locally; running a container enables us to 
shield ourselves from potential vulnerabilities, as well as gives us a sandbox-esque enviorment to let our
